      ...
      <div class="container">
        ...
        <div class="navbar-icons">
          ...
          <div :class="['dropdown', { 'dropdown-dark': isDarkTheme }]">
            <button class="btn btn-link navbar-icon dropdown-toggle custom-dropdown-toggle" type="button"
            ...
            <div class="dropdown-menu dropdown-menu-dark dropdown-menu-end" aria-labelledby="languageDropdown">
              <a v-for="language in supportedLanguages" :key="language" class="dropdown-item"
                :class="{ active: currentLocale === language }" @click="changeLanguage(language)">
                {{ language }}
              </a>
            </div>
          </div>
